...
<div class="ui-widget-content box">
	...
	<div id="searchOptions" class="hidden">
		<div class="left">
			Last Mentioned: <input id="lastMentionedValue" class="triggerSearch">
			<?php
		...
		<div class="left">
			Size: bigger than <input id="sizeMinValue" class="triggerSearch">
			<?php
			arrayToSelect('sizeMinSelect', $sizeArray);
			?>
			smaller than <input id="sizeMaxValue" class="triggerSearch">
			<?php
